...
fn parse_script_config_arg(raw_config: &str) -> Result<serde_json::Value, String> {
...
async fn main() -> ExitCode {
    ...
    match dna_builder_lib::run_script_cli(cli_args.script_path, cli_args.script_config).await {
        Ok(result) => {
