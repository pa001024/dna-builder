...
<template>
    ...
    >
        <div class="card-body bg-linear-30 from-purple-300/50 to-purple-600/50 rounded-xs relative p-2">
            <img
            ...
            <div v-if="weapon.unLocked" class="absolute p-1 px-2 rounded-xs right-1 aura-pulse-dark">
                <span class="aura-pulse-aura"></span>
