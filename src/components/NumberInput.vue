...
<template>
    <div class="inline-flex justify-center items-center overflow-hidden w-fit" v-bind="$attrs">
        <button type="button" class="btn btn-ghost size-6 btn-square" @click.stop="decrement">-</button>
        <div class="w-8 h-8 flex items-center justify-center px-2">
            {{ props.modelValue }}
        </div>
        <button type="button" class="btn btn-ghost size-6 btn-square" @click.stop="increment">+</button>
    </div>
</template>
