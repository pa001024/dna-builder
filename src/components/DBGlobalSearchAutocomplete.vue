    ...
    <div class="relative w-full">
        <div class="relative">
            <input
                ...
                class="w-full pl-10 pr-3 py-2 rounded-lg bg-base-200 text-base-content placeholder-base-content/60 outline-none border border-base-300 focus:border-primary transition-all duration-200"
        ...
        >
            ...
            <div v-else class="max-h-96 overflow-y-auto">
                <button
                    ...
                    :key="option.id"
                    type="button"
                    class="w-full text-left px-3 py-2.5 border-b border-base-200/80 last:border-b-0 hover:bg-base-200 transition-colors duration-200"
