...
function applyPreset(preset: "low" | "medium" | "high" | "ultra") {
    const presets: Record<string, Record<string, any>> = {
        ...
        medium: {
            "SystemSettings|r.PostProcessQuality": 1,
            "SystemSettings|r.ViewDistanceScale": 0.75,
            "SystemSettings|r.DefaultFeature.Bloom": 1,
            "SystemSettings|r.DefaultFeature.AmbientOcclusion": 1,
            "SystemSettings|r.DefaultFeature.MotionBlur": "True",
            "SystemSettings|r.Tonemapper.Quality": 1,
            "SystemSettings|r.LightShaftQuality": 1,
            "SystemSettings|r.Filter.SizeScale": 0.8,
            "SystemSettings|r.Tonemapper.GrainQuantization": 1,
            "SystemSettings|r.MaxAnisotropy": 2,
            "SystemSettings|r.TranslucencyVolumeBlur": 1,
            "SystemSettings|r.MaterialQualityLevel": 1,
            "SystemSettings|r.SSS.Scale": 1,
            "SystemSettings|r.SSS.SampleSet": 1,
            "SystemSettings|foliage.DiscardDataOnLoad": 0,
            "SystemSettings|foliage.MaxTrianglesToRender": 100,
            "SystemSettings|r.Shadow.MaxCSMResolution": 512,
            "SystemSettings|r.Shadow.CSM.MaxCascades": 2,
            "SystemSettings|r.ParticleLightQuality": 1,
            "SystemSettings|r.SkyLightingQuality": 1,
            "SystemSettings|r.Streaming.PoolSize": 128,
            "SystemSettings|r.Streaming.MaxTempMemoryAllowed": 128,
            "SystemSettings|fx.Niagara.QualityLevel": 1,
            "SystemSettings|r.MipMapLODBias": 2,
            "SystemSettings|r.Streaming.MipBias": 1,
            "SystemSettings|r.Streaming.AmortizeCPUToGPUCopy": 1,
            "SystemSettings|r.Streaming.MaxNumTexturesToStreamPerFrame": 10,
            "SystemSettings|r.Streaming.Boost": 1,
            "SystemSettings|r.MaxQualityMode": 1,
            "SystemSettings|r.ViewDistanceScale.ApplySecondaryScale": 1,
            "SystemSettings|r.ViewDistanceScale.SecondaryScale": 0.75,
            "SystemSettings|r.SkeletalMeshLODBias": 2,
            "SystemSettings|r.StaticMeshLODDistanceScale": 3,
            "SystemSettings|r.SkeletalMesh.MinLodQualityLevel": 0,
            "SystemSettings|r.Streaming.LimitPoolSizeToVRAM": 1,
            "SystemSettings|r.Streaming.UseFixedPoolSize": 1,
            "SystemSettings|r.Streaming.HLODStrategy": 1,
            "SystemSettings|r.Streaming.PerTextureBiasViewBoostEnabled": 1,
            "SystemSettings|r.SkeletalMesh.StreamLODsEnabled": 1,
            "SystemSettings|r.DistanceFieldShadowing": 0,
            "SystemSettings|r.DistanceFieldAO": 0,
            "SystemSettings|r.DynamicGlobalIlluminationMethod": 0,
            "SystemSettings|r.ReflectionMethod": 0,
            ...
            "SystemSettings|r.FinishCurrentFrame": 0,
            "SystemSettings|r.BasePassForceOutputsVelocity": 0,
            "SystemSettings|r.MotionBlurQuality": 1,
            "SystemSettings|r.AmbientOcclusionLevels": 1,
            "SystemSettings|r.GBufferFormat": 1,
            "SystemSettings|r.VirtualTexture": 0,
            "SystemSettings|r.LightFunctionQuality": 1,
            "SystemSettings|r.ShadowQuality": 1,
            "SystemSettings|r.Shadow.MaxResolution": 512,
            "SystemSettings|r.Shadow.RadiusThreshold": 0.05,
            "SystemSettings|r.Shadow.DistanceScale": 0.3,
            "SystemSettings|r.AllowLandscapeShadows": 1,
            "SystemSettings|ContactShadows": 0,
            "SystemSettings|r.VolumetricFog": 0,
            "SystemSettings|r.Fog": 1,
            "SystemSettings|r.LightShafts": 1,
            "SystemSettings|r.BloomQuality": 1,
            "SystemSettings|r.EyeAdaptationQuality": 1,
            "SystemSettings|r.TonemapperQuality": 1,
            "SystemSettings|r.AmbientOcclusionRadiusScale": 1,
            "SystemSettings|r.LensFlareQuality": 1,
            "SystemSettings|r.SceneColorFringeQuality": 1,
            "SystemSettings|r.DepthOfFieldQuality": 1,
            "SystemSettings|r.RenderTargetPoolMin": 200,
            "SystemSettings|r.Upscale.Quality": 1,
            "SystemSettings|r.TemporalAA.Upsampling": 1,
            "SystemSettings|r.PostProcessAAQuality": 1,
            "SystemSettings|r.ScreenPercentage": 75,
            "SystemSettings|r.RefractionQuality": 1,
            "SystemSettings|r.ReflectionEnvironment": 1,
            "SystemSettings|r.SSR.Quality": 1,
            "SystemSettings|r.SSR.Temporal": 1,
            "SystemSettings|r.SSR.HalfResSceneColor": 1,
            "SystemSettings|fx.MaxCPUParticlesPerEmitter": 50,
            "SystemSettings|r.EmitterSpawnRateScale": 0.5,
            "SystemSettings|r.FastBlurThreshold": 0.5,
            "SystemSettings|r.TranslucencyLightingVolumeDim": 2,
            "SystemSettings|foliage.DensityScale": 0.5,
            "SystemSettings|grass.DensityScale": 0.5,
            "SystemSettings|r.LODDistanceFactor": 2,
            "SystemSettings|r.DetailMode": 1,
            "SystemSettings|r.DefaultFeature.AutoExposure": "True",
            "SystemSettings|r.DefaultFeature.LensFlare": "True",
            "SystemSettings|r.DefaultFeature.LightUnits": 1,
            "SystemSettings|r.HZBOcclusion": 0,
            "SystemSettings|r.FastVRam.Tonemapping": 0,
            "SystemSettings|r.FastVRam.Bloom": 0,
            "SystemSettings|r.FastVRam.DistanceFieldAOHZB": 0,
            "SystemSettings|r.SceneColorFormat": 4,
            "SystemSettings|r.SupportSkyAtmosphere": 1,
            "SystemSettings|r.SupportLowQualityLightmaps": 1,
            "SystemSettings|r.SupportPointLightWholeSceneShadows": 0,
            "SystemSettings|r.SupportSkyLighting": 1,
            "SystemSettings|r.SupportStationarySkylight": 1,
            "SystemSettings|r.MobileHDR": 1,
            "SystemSettings|r.bForceCPUUpdateBoundingBoxes": 0,
            "SystemSettings|r.DisableLODFade": 0,
            "SystemSettings|r.Tessellation": 1,
            "SystemSettings|r.Occlusion.MaxPixelShaderDiffuseLuminance": 0.1,
            "SystemSettings|r.ForceLOD": 0,
            "SystemSettings|r.LightmapStreaming": 1,
            "SystemSettings|r.LightmapStreaming.MaxRequestedMipBias": 1,
            "SystemSettings|r.GTS.Async": 1,
            "SystemSettings|r.Streaming.FullyLoadUsedTextures": 0,
            "SystemSettings|r.Streaming.DefragDynamicBounds": 0,
            "SystemSettings|r.Streaming.UnloadDoneInManagerTick": 0,
            "SystemSettings|r.Streaming.UseMipsFarAway": 1,
            "SystemSettings|r.Streaming.FullyLoadLODs": 0,
            "SystemSettings|r.Streaming.MaxEffectiveSize": 200,
            "SystemSettings|r.Streaming.HiddenPrimitiveScale": 1.5,
            "SystemSettings|r.CustomDepth": 1,
            "SystemSettings|r.AllowGlobalClipPlane": 0,
            "SystemSettings|r.AllowCompaction": 1,
            "SystemSettings|r.Streaming.MaxTextureSize": 1024,
            "SystemSettings|r.ForceReleaseTextureImmediately": 0,
            "SystemSettings|r.MSAACount": 1,
            "SystemSettings|r.HLOD": 1,
            "SystemSettings|r.HLOD.VisibilityQueryLODOffset": 1,
            "/Script/Engine.RendererSettings|r.Mobile.DisableVertexFog": "False",
            "/Script/Engine.RendererSettings|r.DefaultFeature.Bloom": "True",
            "/Script/Engine.RendererSettings|r.DefaultFeature.AmbientOcclusion": "True",
            "/Script/Engine.RendererSettings|r.DefaultFeature.AntiAliasing": 1,
            "/Script/Engine.RendererSettings|r.DefaultFeature.LensFlare": "True",
            "/Script/Engine.RendererSettings|r.DefaultFeature.LightUnits": 1,
            "/Script/Engine.RendererSettings|r.MobileHDR": "True",
            "/Script/Engine.RendererSettings|r.AllowOcclusionQueries": "True",
            "/Script/Engine.RendererSettings|r.SupportLowQualityLightmaps": "True",
            "/Script/Engine.RendererSettings|r.SupportStationarySkylight": "True",
            "/Script/Engine.RendererSettings|r.SupportSkyLighting": "True",
            "/Script/Engine.RendererSettings|r.SupportPointLightWholeSceneShadows": "False",
            "/Script/Engine.RendererSettings|r.Shadow.CSM.MaxCascades": 2,
            "/Script/Engine.RendererSettings|r.ReflectionEnvironment": "True",
            "/Script/Engine.RendererSettings|r.ReflectionCaptureResolution": 128,
            "/Script/Engine.RendererSettings|r.TranslucentSortPolicy": 1,
            "/Script/Engine.RendererSettings|r.DistanceFieldAO": "False",
            "/Script/Engine.RendererSettings|r.DistanceFieldShadowing": "False",
            "/Script/Engine.RendererSettings|r.RayTracing": "False",
            "ConsoleVariables|r.Streaming.MaxDynamicPoolSize": 200,
            "ConsoleVariables|r.Streaming.FramesForFullUpdate": 15,
            "ConsoleVariables|r.UseShaderCaching": 1,
            "ConsoleVariables|r.UseAsyncPrecompile": 1,
            "ConsoleVariables|r.UseAsyncPrecompileForFeatureLevelUpgrade": 1,
            ...
            "ConsoleVariables|r.ParallelSceneRendering": 1,
            "ConsoleVariables|fx.ParallelSystemEvaluation": 1,
            "ConsoleVariables|fx.MaxGPUParticlesSpawnCount": 1024,
            "ConsoleVariables|r.DoParallelDepthPrepass": 1,
        },
        high: {
            "SystemSettings|r.PostProcessQuality": 2,
            "SystemSettings|r.ViewDistanceScale": 1,
            "SystemSettings|r.DefaultFeature.Bloom": 1,
            "SystemSettings|r.DefaultFeature.AmbientOcclusion": 1,
            "SystemSettings|r.DefaultFeature.MotionBlur": "True",
            "SystemSettings|r.Tonemapper.Quality": 2,
            "SystemSettings|r.LightShaftQuality": 2,
            "SystemSettings|r.Filter.SizeScale": 1,
            "SystemSettings|r.Tonemapper.GrainQuantization": 2,
            "SystemSettings|r.MaxAnisotropy": 4,
            "SystemSettings|r.TranslucencyVolumeBlur": 1,
            "SystemSettings|r.MaterialQualityLevel": 2,
            "SystemSettings|r.SSS.Scale": 1,
            "SystemSettings|r.SSS.SampleSet": 2,
            "SystemSettings|foliage.DiscardDataOnLoad": 0,
            "SystemSettings|foliage.MaxTrianglesToRender": 500,
            "SystemSettings|r.Shadow.MaxCSMResolution": 1024,
            "SystemSettings|r.Shadow.CSM.MaxCascades": 3,
            "SystemSettings|r.ParticleLightQuality": 2,
            "SystemSettings|r.SkyLightingQuality": 2,
            "SystemSettings|r.Streaming.PoolSize": 256,
            "SystemSettings|r.Streaming.MaxTempMemoryAllowed": 256,
            "SystemSettings|fx.Niagara.QualityLevel": 2,
            "SystemSettings|r.MipMapLODBias": 1,
            "SystemSettings|r.Streaming.MipBias": 0,
            "SystemSettings|r.Streaming.AmortizeCPUToGPUCopy": 1,
            "SystemSettings|r.Streaming.MaxNumTexturesToStreamPerFrame": 20,
            "SystemSettings|r.Streaming.Boost": 1,
            "SystemSettings|r.MaxQualityMode": 2,
            "SystemSettings|r.ViewDistanceScale.ApplySecondaryScale": 1,
            "SystemSettings|r.ViewDistanceScale.SecondaryScale": 1,
            "SystemSettings|r.SkeletalMeshLODBias": 1,
            "SystemSettings|r.StaticMeshLODDistanceScale": 2,
            "SystemSettings|r.SkeletalMesh.MinLodQualityLevel": 0,
            "SystemSettings|r.Streaming.LimitPoolSizeToVRAM": 1,
            "SystemSettings|r.Streaming.UseFixedPoolSize": 1,
            "SystemSettings|r.Streaming.HLODStrategy": 0,
            "SystemSettings|r.Streaming.PerTextureBiasViewBoostEnabled": 1,
            "SystemSettings|r.SkeletalMesh.StreamLODsEnabled": 1,
            "SystemSettings|r.DistanceFieldShadowing": 1,
            "SystemSettings|r.DistanceFieldAO": 1,
            "SystemSettings|r.DynamicGlobalIlluminationMethod": 0,
            "SystemSettings|r.ReflectionMethod": 1,
            "SystemSettings|r.GenerateMeshDistanceFields": 1,
            "SystemSettings|r.RayTracing": 0,
            "SystemSettings|r.Lumen.DiffuseIndirect.Allow": 0,
            "SystemSettings|r.Lumen.Reflections.Allow": 0,
            "SystemSettings|r.Lumen.ScreenProbeGather.Allow": 0,
            "SystemSettings|r.FinishCurrentFrame": 0,
            "SystemSettings|r.BasePassForceOutputsVelocity": 0,
            "SystemSettings|r.MotionBlurQuality": 2,
            "SystemSettings|r.AmbientOcclusionLevels": 2,
            "SystemSettings|r.GBufferFormat": 1,
            "SystemSettings|r.VirtualTexture": 0,
            "SystemSettings|r.LightFunctionQuality": 2,
            "SystemSettings|r.ShadowQuality": 2,
            "SystemSettings|r.Shadow.MaxResolution": 1024,
            "SystemSettings|r.Shadow.RadiusThreshold": 0.07,
            "SystemSettings|r.Shadow.DistanceScale": 0.5,
            "SystemSettings|r.AllowLandscapeShadows": 1,
            "SystemSettings|ContactShadows": 1,
            "SystemSettings|r.VolumetricFog": 1,
            "SystemSettings|r.Fog": 1,
            "SystemSettings|r.LightShafts": 1,
            "SystemSettings|r.BloomQuality": 2,
            "SystemSettings|r.EyeAdaptationQuality": 2,
            "SystemSettings|r.TonemapperQuality": 2,
            "SystemSettings|r.AmbientOcclusionRadiusScale": 1,
            "SystemSettings|r.LensFlareQuality": 2,
            "SystemSettings|r.SceneColorFringeQuality": 2,
            "SystemSettings|r.DepthOfFieldQuality": 2,
            "SystemSettings|r.RenderTargetPoolMin": 300,
            "SystemSettings|r.Upscale.Quality": 2,
            "SystemSettings|r.TemporalAA.Upsampling": 1,
            "SystemSettings|r.PostProcessAAQuality": 2,
            "SystemSettings|r.ScreenPercentage": 100,
            "SystemSettings|r.RefractionQuality": 2,
            "SystemSettings|r.ReflectionEnvironment": 1,
            "SystemSettings|r.SSR.Quality": 2,
            "SystemSettings|r.SSR.Temporal": 1,
            "SystemSettings|r.SSR.HalfResSceneColor": 0,
            "SystemSettings|fx.MaxCPUParticlesPerEmitter": 100,
            "SystemSettings|r.EmitterSpawnRateScale": 1,
            "SystemSettings|r.FastBlurThreshold": 1,
            "SystemSettings|r.TranslucencyLightingVolumeDim": 3,
            "SystemSettings|foliage.DensityScale": 1,
            "SystemSettings|grass.DensityScale": 1,
            "SystemSettings|r.LODDistanceFactor": 1,
            "SystemSettings|r.DetailMode": 2,
            "SystemSettings|r.DefaultFeature.AutoExposure": "True",
            "SystemSettings|r.DefaultFeature.LensFlare": "True",
            "SystemSettings|r.DefaultFeature.LightUnits": 1,
            "SystemSettings|r.HZBOcclusion": 1,
            "SystemSettings|r.FastVRam.Tonemapping": 1,
            "SystemSettings|r.FastVRam.Bloom": 1,
            "SystemSettings|r.FastVRam.DistanceFieldAOHZB": 1,
            "SystemSettings|r.SceneColorFormat": 4,
            "SystemSettings|r.SupportSkyAtmosphere": 1,
            "SystemSettings|r.SupportLowQualityLightmaps": 0,
            "SystemSettings|r.SupportPointLightWholeSceneShadows": 1,
            "SystemSettings|r.SupportSkyLighting": 1,
            "SystemSettings|r.SupportStationarySkylight": 1,
            "SystemSettings|r.MobileHDR": 1,
            "SystemSettings|r.bForceCPUUpdateBoundingBoxes": 0,
            "SystemSettings|r.DisableLODFade": 0,
            "SystemSettings|r.Tessellation": 1,
            "SystemSettings|r.Occlusion.MaxPixelShaderDiffuseLuminance": 0.2,
            "SystemSettings|r.ForceLOD": 0,
            "SystemSettings|r.LightmapStreaming": 1,
            "SystemSettings|r.LightmapStreaming.MaxRequestedMipBias": 0,
            "SystemSettings|r.GTS.Async": 1,
            "SystemSettings|r.Streaming.FullyLoadUsedTextures": 0,
            "SystemSettings|r.Streaming.DefragDynamicBounds": 0,
            "SystemSettings|r.Streaming.UnloadDoneInManagerTick": 0,
            "SystemSettings|r.Streaming.UseMipsFarAway": 1,
            "SystemSettings|r.Streaming.FullyLoadLODs": 0,
            "SystemSettings|r.Streaming.MaxEffectiveSize": 300,
            "SystemSettings|r.Streaming.HiddenPrimitiveScale": 1,
            "SystemSettings|r.CustomDepth": 1,
            "SystemSettings|r.AllowGlobalClipPlane": 1,
            "SystemSettings|r.AllowCompaction": 1,
            "SystemSettings|r.Streaming.MaxTextureSize": 2048,
            "SystemSettings|r.ForceReleaseTextureImmediately": 0,
            "SystemSettings|r.MSAACount": 2,
            "SystemSettings|r.HLOD": 0,
            "SystemSettings|r.HLOD.VisibilityQueryLODOffset": 0,
            "/Script/Engine.RendererSettings|r.Mobile.DisableVertexFog": "False",
            "/Script/Engine.RendererSettings|r.DefaultFeature.Bloom": "True",
            "/Script/Engine.RendererSettings|r.DefaultFeature.AmbientOcclusion": "True",
            ...
            "/Script/Engine.RendererSettings|r.MobileHDR": "True",
            "/Script/Engine.RendererSettings|r.AllowOcclusionQueries": "True",
            "/Script/Engine.RendererSettings|r.SupportLowQualityLightmaps": "False",
            "/Script/Engine.RendererSettings|r.SupportStationarySkylight": "True",
            "/Script/Engine.RendererSettings|r.SupportSkyLighting": "True",
            "/Script/Engine.RendererSettings|r.SupportPointLightWholeSceneShadows": "True",
            "/Script/Engine.RendererSettings|r.Shadow.CSM.MaxCascades": 3,
            "/Script/Engine.RendererSettings|r.ReflectionEnvironment": "True",
            "/Script/Engine.RendererSettings|r.ReflectionCaptureResolution": 256,
            "/Script/Engine.RendererSettings|r.TranslucentSortPolicy": 2,
            "/Script/Engine.RendererSettings|r.DistanceFieldAO": "True",
            "/Script/Engine.RendererSettings|r.DistanceFieldShadowing": "True",
            "/Script/Engine.RendererSettings|r.RayTracing": "False",
            "ConsoleVariables|r.Streaming.MaxDynamicPoolSize": 300,
            "ConsoleVariables|r.Streaming.FramesForFullUpdate": 15,
            "ConsoleVariables|r.UseShaderCaching": 1,
            "ConsoleVariables|r.UseAsyncPrecompile": 1,
            "ConsoleVariables|r.UseAsyncPrecompileForFeatureLevelUpgrade": 1,
            "ConsoleVariables|r.TargetPrecompileFrameTime": 10,
            "ConsoleVariables|r.PrecompileShadersForFeatureLevel": 1,
            "ConsoleVariables|r.GPUCulling": 1,
            "ConsoleVariables|r.EarlyZPass": 2,
            "ConsoleVariables|r.ParallelSceneRendering": 1,
            "ConsoleVariables|fx.ParallelSystemEvaluation": 1,
            "ConsoleVariables|fx.MaxGPUParticlesSpawnCount": 2048,
            "ConsoleVariables|r.DoParallelDepthPrepass": 1,
        },
        ultra: {
            "SystemSettings|r.PostProcessQuality": 3,
            "SystemSettings|r.ViewDistanceScale": 1.5,
            "SystemSettings|r.DefaultFeature.Bloom": 1,
            "SystemSettings|r.DefaultFeature.AmbientOcclusion": 1,
            "SystemSettings|r.DefaultFeature.MotionBlur": "True",
            "SystemSettings|r.Tonemapper.Quality": 3,
            "SystemSettings|r.LightShaftQuality": 3,
            "SystemSettings|r.Filter.SizeScale": 1,
            "SystemSettings|r.Tonemapper.GrainQuantization": 3,
            "SystemSettings|r.MaxAnisotropy": 8,
            "SystemSettings|r.TranslucencyVolumeBlur": 1,
            "SystemSettings|r.MaterialQualityLevel": 3,
            "SystemSettings|r.SSS.Scale": 1,
            "SystemSettings|r.SSS.SampleSet": 3,
            "SystemSettings|foliage.DiscardDataOnLoad": 0,
            "SystemSettings|foliage.MaxTrianglesToRender": 1000,
            "SystemSettings|r.Shadow.MaxCSMResolution": 2048,
            "SystemSettings|r.Shadow.CSM.MaxCascades": 4,
            "SystemSettings|r.ParticleLightQuality": 3,
            "SystemSettings|r.SkyLightingQuality": 3,
            "SystemSettings|r.Streaming.PoolSize": 512,
            "SystemSettings|r.Streaming.MaxTempMemoryAllowed": 512,
            "SystemSettings|fx.Niagara.QualityLevel": 3,
            "SystemSettings|r.MipMapLODBias": 0,
            "SystemSettings|r.Streaming.MipBias": 0,
            "SystemSettings|r.Streaming.AmortizeCPUToGPUCopy": 1,
            "SystemSettings|r.Streaming.MaxNumTexturesToStreamPerFrame": 50,
            "SystemSettings|r.Streaming.Boost": 1,
            "SystemSettings|r.MaxQualityMode": 3,
            "SystemSettings|r.ViewDistanceScale.ApplySecondaryScale": 1,
            "SystemSettings|r.ViewDistanceScale.SecondaryScale": 1.5,
            "SystemSettings|r.SkeletalMeshLODBias": 0,
            "SystemSettings|r.StaticMeshLODDistanceScale": 1,
            "SystemSettings|r.SkeletalMesh.MinLodQualityLevel": 0,
            "SystemSettings|r.Streaming.LimitPoolSizeToVRAM": 1,
            "SystemSettings|r.Streaming.UseFixedPoolSize": 1,
            "SystemSettings|r.Streaming.HLODStrategy": 0,
            ...
            "SystemSettings|r.DistanceFieldShadowing": 1,
            "SystemSettings|r.DistanceFieldAO": 1,
            "SystemSettings|r.DynamicGlobalIlluminationMethod": 1,
            "SystemSettings|r.ReflectionMethod": 2,
            "SystemSettings|r.GenerateMeshDistanceFields": 1,
            "SystemSettings|r.RayTracing": 1,
            "SystemSettings|r.Lumen.DiffuseIndirect.Allow": 1,
            "SystemSettings|r.Lumen.Reflections.Allow": 1,
            "SystemSettings|r.Lumen.ScreenProbeGather.Allow": 1,
            "SystemSettings|r.FinishCurrentFrame": 0,
            "SystemSettings|r.BasePassForceOutputsVelocity": 0,
            "SystemSettings|r.MotionBlurQuality": 3,
            "SystemSettings|r.AmbientOcclusionLevels": 3,
            "SystemSettings|r.GBufferFormat": 1,
            "SystemSettings|r.VirtualTexture": 1,
            "SystemSettings|r.LightFunctionQuality": 3,
            "SystemSettings|r.ShadowQuality": 3,
            "SystemSettings|r.Shadow.MaxResolution": 2048,
            "SystemSettings|r.Shadow.RadiusThreshold": 0.1,
            "SystemSettings|r.Shadow.DistanceScale": 1,
            "SystemSettings|r.AllowLandscapeShadows": 1,
            "SystemSettings|ContactShadows": 1,
            "SystemSettings|r.VolumetricFog": 1,
            "SystemSettings|r.Fog": 1,
            "SystemSettings|r.LightShafts": 1,
            "SystemSettings|r.BloomQuality": 3,
            "SystemSettings|r.EyeAdaptationQuality": 3,
            "SystemSettings|r.TonemapperQuality": 3,
            "SystemSettings|r.AmbientOcclusionRadiusScale": 1,
            "SystemSettings|r.LensFlareQuality": 3,
            "SystemSettings|r.SceneColorFringeQuality": 3,
            "SystemSettings|r.DepthOfFieldQuality": 3,
            "SystemSettings|r.RenderTargetPoolMin": 500,
            "SystemSettings|r.Upscale.Quality": 3,
            "SystemSettings|r.TemporalAA.Upsampling": 1,
            "SystemSettings|r.PostProcessAAQuality": 3,
            "SystemSettings|r.ScreenPercentage": 150,
            "SystemSettings|r.RefractionQuality": 3,
            "SystemSettings|r.ReflectionEnvironment": 1,
            "SystemSettings|r.SSR.Quality": 3,
            "SystemSettings|r.SSR.Temporal": 1,
            "SystemSettings|r.SSR.HalfResSceneColor": 0,
            "SystemSettings|fx.MaxCPUParticlesPerEmitter": 200,
            "SystemSettings|r.EmitterSpawnRateScale": 1,
            "SystemSettings|r.FastBlurThreshold": 1,
            "SystemSettings|r.TranslucencyLightingVolumeDim": 4,
            "SystemSettings|foliage.DensityScale": 1,
            "SystemSettings|grass.DensityScale": 1,
            "SystemSettings|r.LODDistanceFactor": 0.5,
            "SystemSettings|r.DetailMode": 2,
            "SystemSettings|r.DefaultFeature.AutoExposure": "True",
            "SystemSettings|r.DefaultFeature.LensFlare": "True",
            "SystemSettings|r.DefaultFeature.LightUnits": 1,
            ...
            "SystemSettings|r.DisableLODFade": 0,
            "SystemSettings|r.Tessellation": 1,
            "SystemSettings|r.Occlusion.MaxPixelShaderDiffuseLuminance": 0.5,
            "SystemSettings|r.ForceLOD": 0,
            "SystemSettings|r.LightmapStreaming": 1,
            "SystemSettings|r.LightmapStreaming.MaxRequestedMipBias": 0,
            "SystemSettings|r.GTS.Async": 1,
            "SystemSettings|r.Streaming.FullyLoadUsedTextures": 1,
            "SystemSettings|r.Streaming.DefragDynamicBounds": 1,
            "SystemSettings|r.Streaming.UnloadDoneInManagerTick": 0,
            "SystemSettings|r.Streaming.UseMipsFarAway": 0,
            "SystemSettings|r.Streaming.FullyLoadLODs": 1,
            "SystemSettings|r.Streaming.MaxEffectiveSize": 500,
            "SystemSettings|r.Streaming.HiddenPrimitiveScale": 1,
            "SystemSettings|r.CustomDepth": 1,
            "SystemSettings|r.AllowGlobalClipPlane": 1,
            "SystemSettings|r.AllowCompaction": 1,
            "SystemSettings|r.Streaming.MaxTextureSize": 4096,
            "SystemSettings|r.ForceReleaseTextureImmediately": 0,
            "SystemSettings|r.MSAACount": 4,
            "SystemSettings|r.HLOD": 0,
            "SystemSettings|r.HLOD.VisibilityQueryLODOffset": 0,
            "/Script/Engine.RendererSettings|r.Mobile.DisableVertexFog": "False",
            "/Script/Engine.RendererSettings|r.DefaultFeature.Bloom": "True",
            "/Script/Engine.RendererSettings|r.DefaultFeature.AmbientOcclusion": "True",
            "/Script/Engine.RendererSettings|r.DefaultFeature.AntiAliasing": 3,
            "/Script/Engine.RendererSettings|r.DefaultFeature.LensFlare": "True",
            "/Script/Engine.RendererSettings|r.DefaultFeature.LightUnits": 1,
            "/Script/Engine.RendererSettings|r.MobileHDR": "True",
            "/Script/Engine.RendererSettings|r.AllowOcclusionQueries": "True",
            ...
            "/Script/Engine.RendererSettings|r.SupportSkyLighting": "True",
            "/Script/Engine.RendererSettings|r.SupportPointLightWholeSceneShadows": "True",
            "/Script/Engine.RendererSettings|r.Shadow.CSM.MaxCascades": 4,
            "/Script/Engine.RendererSettings|r.ReflectionEnvironment": "True",
            "/Script/Engine.RendererSettings|r.ReflectionCaptureResolution": 512,
            "/Script/Engine.RendererSettings|r.TranslucentSortPolicy": 2,
            "/Script/Engine.RendererSettings|r.DistanceFieldAO": "True",
            "/Script/Engine.RendererSettings|r.DistanceFieldShadowing": "True",
            "/Script/Engine.RendererSettings|r.RayTracing": "True",
            "ConsoleVariables|r.Streaming.MaxDynamicPoolSize": 500,
            "ConsoleVariables|r.Streaming.FramesForFullUpdate": 15,
            "ConsoleVariables|r.UseShaderCaching": 1,
            "ConsoleVariables|r.UseAsyncPrecompile": 1,
            "ConsoleVariables|r.UseAsyncPrecompileForFeatureLevelUpgrade": 1,
            ...
            "ConsoleVariables|r.ParallelSceneRendering": 1,
            "ConsoleVariables|fx.ParallelSystemEvaluation": 1,
            "ConsoleVariables|fx.MaxGPUParticlesSpawnCount": 4096,
            "ConsoleVariables|r.DoParallelDepthPrepass": 1,
        },
    }
