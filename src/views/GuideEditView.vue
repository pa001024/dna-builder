                            ...
                            <div v-if="images.length > 0" class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div v-for="(image, index) in images" :key="index" class="relative group aspect-square">
                                        <img
                                            :src="image"
                                            class="w-full h-full object-cover rounded-xl shadow-sm group-hover:shadow-md transition-shadow duration-200"
                                        />
                                        <button
                                            class="absolute top-2 right-2 btn btn-sm btn-circle btn-error opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-lg"
