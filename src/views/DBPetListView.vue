...
<template>
    <div class="h-full flex flex-col">
        <SplitView
            :desktop-ratio="1 / 2"
            :detail-open="Boolean(selectedPet || selectedPetEntry)"
            @collapse="selectedPetId = 0"
        >
            <template #master>
            ...
            <!-- 右侧详情面板 -->
            <ScrollArea v-if="selectedPet" class="min-h-0 min-w-0 flex-1">
                <DBPetDetailItem :key="selectedPetId" :pet="selectedPet" />
            </ScrollArea>

            <ScrollArea v-else-if="selectedPetEntry" class="min-h-0 min-w-0 flex-1">
