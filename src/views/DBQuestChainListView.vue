...
<template>
    <div class="h-full flex flex-col">
        <SplitView
            :desktop-ratio="1 / 3"
            :detail-open="Boolean(selectedQuestChain)"
            @collapse="selectQuestChain(null)"
        >
            <template #master>
            ...
            <!-- 右侧详情面板 -->
            <ScrollArea v-if="selectedQuestChain" :key="selectedQuestChain.id" class="min-h-0 min-w-0 flex-2">
                <DBQuestDetailItem
