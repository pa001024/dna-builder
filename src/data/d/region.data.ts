...
export const region2Version: Record<number, string> = {
    ...
    1053: "1.3",
    1055: "1.3",
    // 1.4：车站区域（地上/地下），1.5 无新增地图 region
    1060: "1.4",
    1063: "1.4",
    // 1.6：EX 第二章 阿尔卡诺系列地图
    1070: "1.6",
...
const t: Region[] = [
    ...
    },
    {
        ...
        type: "EX",
        mapId: 600,
        mapImage: "WBP_Map_Reg_EXChapter02_Lxzs01",
        mapCenter: [-10762, -45312],
        mapScale: [0.3, 1.25],
        isRandom: [107001],
        alertDisable: true,
        mapMapping: [
            {
                name: "WBP_Map_EXChapter02_Lxzs01",
                pos: [0, 0, 8192, 4096],
                opacity: 1,
                zOrder: 0,
            },
    ...
    },
    {
        ...
        type: "EX",
        mapId: 601,
        mapImage: "WBP_Map_Reg_EXChapter02_Lxzs02",
        mapCenter: [-45300, -33330],
        mapScale: [0.3, 1.25],
        isRandom: [107101],
        alertDisable: true,
        mapMapping: [
            {
                name: "WBP_Map_EXChapter02_Lxzs02",
                pos: [0, 0, 8192, 8192],
                opacity: 1,
                zOrder: 0,
            },
    ...
    },
    {
        ...
        type: "EX",
        mapId: 602,
        mapImage: "WBP_Map_Reg_EXChapter02_Lxzx",
        mapCenter: [11990, -27330],
        mapScale: [0.3, 1.25],
        isRandom: [107201],
        alertDisable: true,
        mapMapping: [
            {
                name: "WBP_Map_EXChapter02_Lxzx",
                pos: [0, 0, 8192, 8192],
                opacity: 1,
                zOrder: 0,
            },
    ...
    {
        id: 1090,
        name: "UI_REGION_NAME_1090",
        type: "Main",
        isRandom: [109001],
    },
    {
        id: 1091,
        name: "UI_REGION_NAME_1091",
        type: "Main",
        isRandom: [109101],
    },
    {
        id: 1092,
        name: "UI_REGION_NAME_1092",
        type: "Main",
        isRandom: [109201],
    },
    {
        id: 1093,
        name: "UI_REGION_NAME_1093",
        type: "Main",
        isRandom: [109301],
    },
    {
        id: 1094,
        name: "UI_REGION_NAME_1094",
        type: "Main",
        isRandom: [109401],
    },
    {
