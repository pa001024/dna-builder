...
export const RaidBuff = [
    ...
    },
    {
        RaidBuffID: 16,
        RaidBuffDes:
            "角色充盈威力大于100%时，每超过100%，造成技能或充盈伤害时无视目标4%防御，最多无视40%防御。\n角色消耗紊乱时，获得触发概率提高60%效果，持续12秒，最多叠加3层。",
    },
].reduce(
    (prev, cur) => {
