...
export type DynQuestType = "Battle" | "Collect" | "Social"
export type DynQuestDemandType =
    | "Battle"
    | "Collect"
    | "Social"
    | "Morality"
...
export type DynQuestLevelDemand = Partial<Record<DynQuestDemandType, number>>

export interface DynQuestLevel {
    id: number
    reward: number[]
    demand: DynQuestLevelDemand
    level: [number, number]
}
...
const DYN_QUEST_TYPE_LABEL_MAP: Record<DynQuestType, string> = {
    Battle: "战斗",
    Collect: "采集",
    Social: "社交",
}

export const DYN_QUEST_TYPE_ICON_MAP: Record<DynQuestType, string> = {
    Battle: "T_Map_IconBattle",
    Collect: "T_Map_IconProduce",
    Social: "T_Map_IconSocial",
}

const DYN_QUEST_DEMAND_LABEL_MAP: Record<DynQuestDemandType, string> = {
    Battle: "战斗",
    Collect: "采集",
    Social: "社交",
    Morality: "道德",
 ...
 * @returns 类型文本
 */
export function getDynQuestTypeLabel(type: DynQuestType): string {
    return DYN_QUEST_TYPE_LABEL_MAP[type] ?? type
}
 ...
 * @returns 需求类型文本
 */
export function getDynQuestDemandLabel(type: DynQuestDemandType): string {
    return DYN_QUEST_DEMAND_LABEL_MAP[type] ?? type
}
 ...
 * @returns 等级段文本
 */
export function formatDynQuestLevelRange(level: DynQuestLevel): string {
    return `${level.level[0]} - ${level.level[1]}`
}
 ...
 * @returns 等级档位键
 */
export function getDynQuestLevelKey(level: DynQuestLevel): string {
    return `${level.level[0]}-${level.level[1]}`
}
 ...
 * @returns 需求文本
 */
export function formatDynQuestDemand(demand: DynQuestLevelDemand): string {
    const parts = Object.entries(demand)
        .filter((entry): entry is [DynQuestDemandType, number] => typeof entry[1] === "number" && entry[1] > 0)
        .map(([type, value]) => `${getDynQuestDemandLabel(type)} ${value}`)
...
const t: DynQuest[] = [
    {
        ...
        levels: [
            {
                id: 101100,
                reward: [40097, 40098, 40099, 40000],
                demand: {
                    Battle: 3,
                },
                level: [1, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 100101,
                reward: [40001, 40002, 40003, 40000],
                demand: {
                    Battle: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100102,
                reward: [40004, 40005, 40006, 40000],
                demand: {
                    Battle: 1,
                },
                level: [30, 39],
    ...
    },
    {
        ...
        levels: [
            {
                id: 100203,
                reward: [40007, 40008, 40009, 40000],
                demand: {
                    Battle: 2,
                },
                level: [40, 49],
            ...
            {
                id: 100204,
                reward: [40010, 40011, 40012, 40000],
                demand: {
                    Battle: 2,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "开车海滩木桶",
                next: ["17212054148203147", "17212055560456186", "17212055621486390"],
                dialogues: [
                    {
                        id: 71000601,
        ...
        levels: [
            {
                id: 100301,
                reward: [40013, 40014, 40015, 40000],
                demand: {
                    Collect: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100302,
                reward: [40016, 40017, 40018, 40000],
                demand: {
                    Collect: 1,
                },
                level: [30, 39],
    ...
    },
    {
        ...
        levels: [
            {
                id: 100401,
                reward: [40019, 40020, 40021, 40000],
                demand: {
                    Collect: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100402,
                reward: [40022, 40023, 40024, 40000],
                demand: {
                    Collect: 1,
                },
                level: [30, 39],
    ...
    },
    {
        ...
        levels: [
            {
                id: 100501,
                reward: [40025, 40026, 40027, 40000],
                demand: {
                    Battle: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100502,
                reward: [40028, 40029, 40030, 40000],
                demand: {
                    Battle: 1,
                },
                level: [30, 39],
            ...
            {
                id: 100503,
                reward: [40031, 40032, 40033, 40000],
                demand: {
                    Battle: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "和猫对话",
                next: ["17156918800071843", "17210353525025752", "17210354719227627", "172103663043210325", "172103676512011795"],
                dialogues: [
                    {
                        id: 71000100,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "猫到达",
                next: ["17210354719227627", "172103663043210325", "172103676512011795"],
                dialogues: [
                    {
                        id: 71000300,
        ...
        levels: [
            {
                id: 100621,
                reward: [40037, 40038, 40039, 40000],
                demand: {
                    Morality: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100622,
                reward: [40043, 40044, 40045, 40000],
                demand: {
                    Morality: 1,
                },
                level: [30, 39],
            ...
            {
                id: 100641,
                reward: [40034, 40035, 40036, 40000],
                demand: {
                    Empathy: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100642,
                reward: [40040, 40041, 40042, 40000],
                demand: {
                    Empathy: 1,
                },
                level: [30, 39],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "和修理工对话",
                next: ["171747334876334482", "171747345059438631", "172197711197315690", "172535480720210231"],
                dialogues: [
                    {
                        id: 71000710,
                        content: "发生什么了？",
        ...
        levels: [
            {
                id: 200701,
                reward: [40046, 40047, 40048, 40000],
                demand: {
                    Collect: 1,
                },
                level: [1, 29],
            ...
            {
                id: 200702,
                reward: [40049, 40050, 40051, 40000],
                demand: {
                    Collect: 2,
                },
                level: [30, 39],
    ...
    },
    {
        ...
        levels: [
            {
                id: 200801,
                reward: [40052, 40053, 40054, 40000],
                demand: {
                    Collect: 1,
                },
                level: [1, 29],
            ...
            {
                id: 200802,
                reward: [40055, 40056, 40057, 40000],
                demand: {
                    Collect: 2,
                },
                level: [30, 39],
            ...
            {
                id: 200803,
                reward: [40058, 40059, 40060, 40000],
                demand: {
                    Collect: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "发现汽车选择是否偷车",
                next: ["17219796749773663", "17219796749773662", "17213855146685809", "17217164209203383"],
                dialogues: [
                    {
                        id: 71001002,
        ...
        levels: [
            {
                id: 100921,
                reward: [40064, 40065, 40066, 40000],
                demand: {
                    Morality: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100922,
                reward: [40070, 40071, 40072, 40000],
                demand: {
                    Morality: 1,
                },
                level: [30, 39],
            ...
            {
                id: 100923,
                reward: [40076, 40077, 40078, 40000],
                demand: {
                    Morality: 2,
                },
                level: [40, 49],
            ...
            {
                id: 100951,
                reward: [40061, 40062, 40063, 40000],
                demand: {
                    Chaos: 1,
                },
                level: [1, 29],
            ...
            {
                id: 100952,
                reward: [40067, 40068, 40069, 40000],
                demand: {
                    Chaos: 1,
                },
                level: [30, 39],
            ...
            {
                id: 100953,
                reward: [40073, 40074, 40075, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "试试？",
                next: ["172172067859712593", "172172079701414449", "172172086324815577"],
                dialogues: [
                    {
                        id: 71001506,
                        content: "这也行？",
        ...
        levels: [
            {
                id: 201031,
                reward: [40082, 40083, 40084, 40000],
                demand: {
                    Wisdom: 1,
                },
                level: [1, 29],
            ...
            {
                id: 201032,
                reward: [40088, 40089, 40090, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [30, 39],
            ...
            {
                id: 201033,
                reward: [40094, 40095, 40096, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [40, 49],
            ...
            {
                id: 201051,
                reward: [40079, 40080, 40081, 40000],
                demand: {
                    Chaos: 1,
                },
                level: [1, 29],
            ...
            {
                id: 201052,
                reward: [40085, 40086, 40087, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [30, 39],
            ...
            {
                id: 201053,
                reward: [40091, 40092, 40093, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "与狩月人交流",
                next: ["17220635389484739", "17220635389484742", "17220635389484746"],
                dialogues: [
                    {
                        id: 71001602,
                        content: "发生什么了？",
        ...
        startIds: ["17217248991461516", "17220635389484744", "17220635389494748"],
        levels: [
            {
                id: 101211,
                reward: [40103, 40104, 40105, 40000],
                demand: {
                    Benefit: 1,
                },
                level: [1, 29],
            ...
            {
                id: 101212,
                reward: [40109, 40110, 40111, 40000],
                demand: {
                    Benefit: 1,
                },
                level: [30, 39],
            ...
            {
                id: 101213,
                reward: [40115, 40116, 40117, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [40, 49],
            ...
            {
                id: 101241,
                reward: [40100, 40101, 40102, 40000],
                demand: {
                    Empathy: 1,
                },
                level: [1, 29],
            ...
            {
                id: 101242,
                reward: [40106, 40107, 40108, 40000],
                demand: {
                    Empathy: 1,
                },
                level: [30, 39],
            ...
            {
                id: 101243,
                reward: [40112, 40113, 40114, 40000],
                demand: {
                    Empathy: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "旁白开车对话",
                next: ["17388976599761101", "17388976599761102"],
                dialogues: [
                    {
                        id: 71001401,
        ...
        levels: [
            {
                id: 101313,
                reward: [40118, 40119, 40120, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [40, 49],
            ...
            {
                id: 101323,
                reward: [40121, 40122, 40123, 40000],
                demand: {
                    Morality: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        levels: [
            {
                id: 101405,
                reward: [40124, 40125, 40126, 40000],
                demand: {
                    Battle: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "皎皎选项对话",
                next: ["1731048472966419189", "1731401599163823084", "1731048503919419693", "172412327851413121"],
                dialogues: [
                    {
                        id: 71001702,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "皎皎开车对话",
                next: ["1731048503919419693", "172412327851413121"],
                dialogues: [
                    {
                        id: 71001704,
        ...
        levels: [
            {
                id: 201503,
                reward: [40127, 40128, 40129, 40000],
                demand: {
                    Battle: 2,
                },
                level: [40, 49],
            ...
            {
                id: 201504,
                reward: [40130, 40131, 40132, 40000],
                demand: {
                    Battle: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 101705,
                reward: [40133, 40134, 40135, 40000],
                demand: {
                    Battle: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "老头巡逻对话2",
                next: ["172536156905613131", "172536156905613134", "172536162102314896", "172536168258416156"],
                dialogues: [
                    {
                        id: 71001807,
                        content: "啧……………………",
        ...
        levels: [
            {
                id: 301802,
                reward: [40136, 40137, 40138, 40000],
                demand: {
                    Battle: 2,
                },
                level: [30, 39],
            ...
            {
                id: 301803,
                reward: [40139, 40140, 40141, 40000],
                demand: {
                    Battle: 3,
                },
                level: [40, 49],
            ...
            {
                id: 301804,
                reward: [40142, 40143, 40144, 40000],
                demand: {
                    Battle: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 102005,
                reward: [40145, 40146, 40147, 40000],
                demand: {
                    Battle: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "选项后补充对话",
                next: ["172413619232913665", "17291653419155639", "17291653482045937", "17291653514126073"],
                dialogues: [
                    {
                        id: 71002007,
                        content: "谢谢你！杰瑞，我的杰瑞……",
        ...
        levels: [
            {
                id: 202123,
                reward: [40151, 40152, 40153, 40000],
                demand: {
                    Morality: 2,
                },
                level: [40, 49],
            ...
            {
                id: 202143,
                reward: [40148, 40149, 40150, 40000],
                demand: {
                    Empathy: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        levels: [
            {
                id: 102205,
                reward: [40154, 40155, 40156, 40000],
                demand: {
                    Battle: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 102305,
                reward: [40157, 40158, 40159, 40000],
                demand: {
                    Battle: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 202405,
                reward: [40160, 40161, 40162, 40000],
                demand: {
                    Collect: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "与士兵对话",
                next: ["17241439433939323", "17267290106769602", "17241439372409087", "17241438689357703"],
                dialogues: [
                    {
                        id: 71002103,
        ...
        levels: [
            {
                id: 102524,
                reward: [40163, 40164, 40165, 40000],
                demand: {
                    Morality: 2,
                },
                level: [50, 59],
            ...
            {
                id: 102525,
                reward: [40169, 40170, 40171, 40000],
                demand: {
                    Morality: 3,
                },
                level: [60, 65],
            ...
            {
                id: 102534,
                reward: [40166, 40167, 40168, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [50, 59],
            ...
            {
                id: 102535,
                reward: [40172, 40173, 40174, 40000],
                demand: {
                    Wisdom: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 302605,
                reward: [40175, 40176, 40177, 40000],
                demand: {
                    Collect: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "NPC对话选项",
                next: ["17262151946634289", "172621726272911179", "172621729332911595"],
                dialogues: [
                    {
                        id: 71002302,
                        content: "谁？！",
        ...
        levels: [
            {
                id: 302705,
                reward: [40178, 40179, 40180, 40000],
                demand: {
                    Collect: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "皎皎npc选项对话",
                next: ["17266461778812492", "17266472150439078", "172664731297311071", "172664729217210673"],
                dialogues: [
                    {
                        id: 71002402,
        ...
        startIds: ["1726642390063168308", "17328680079661246882"],
        levels: [
            {
                id: 302802,
                reward: [40181, 40182, 40183, 40000],
                demand: {
                    Collect: 2,
                },
                level: [30, 39],
            ...
            {
                id: 302803,
                reward: [40184, 40185, 40186, 40000],
                demand: {
                    Collect: 3,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "NPC交互对话",
                next: ["172551303112910139", "172551304133810406"],
                dialogues: [
                    {
                        id: 71001902,
                        content:
        ...
        levels: [
            {
                id: 102905,
                reward: [40187, 40188, 40189, 40000],
                demand: {
                    Collect: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "士兵npc开车对话",
                next: ["17283558999162442", "17283754155976195"],
                dialogues: [
                    {
                        id: 71002501,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "连线完成开车对话",
                next: ["17283561687956868", "17283562494248687"],
                dialogues: [
                    {
                        id: 71002507,
        ...
        levels: [
            {
                id: 303003,
                reward: [40190, 40191, 40192, 40000],
                demand: {
                    Collect: 3,
                },
                level: [40, 49],
            ...
            {
                id: 303004,
                reward: [40193, 40194, 40195, 40000],
                demand: {
                    Collect: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "npc开车对话",
                next: ["17283914455534287", "17283915532677012", "1730189092375207466"],
                dialogues: [
                    {
                        id: 71002601,
        ...
        levels: [
            {
                id: 303103,
                reward: [40196, 40197, 40198, 40000],
                demand: {
                    Mine: 3,
                },
                level: [40, 49],
            ...
            {
                id: 303104,
                reward: [40199, 40200, 40201, 40000],
                demand: {
                    Mine: 3,
                },
                level: [50, 59],
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "主角开车对话",
                next: ["17284433215322065", "17284433215322067", "17284433215322069", "17284434886795019"],
                dialogues: [
                    {
                        id: 71002701,
            ...
            {
                id: "17284541623742048",
                type: "TalkNode",
                name: "击杀秽兽开车",
            },
        ],
        startIds: ["1728443152944815", "17284541623742048"],
        levels: [
            {
                id: 203205,
                reward: [40202, 40203, 40204, 40000],
                demand: {
                    Collect: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "主角开车",
                next: ["1728464074203182288", "1730011198441196943", "1730011276550198239"],
                dialogues: [
                    {
                        id: 71002801,
        ...
        levels: [
            {
                id: 203305,
                reward: [40205, 40206, 40207, 40000],
                demand: {
                    Mine: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "开车对话",
                next: ["1731230657043629799", "1731230717892630959"],
                dialogues: [
                    {
                        id: 71002901,
        ...
        levels: [
            {
                id: 303402,
                reward: [40208, 40209, 40210, 40000],
                demand: {
                    Battle: 2,
                },
                level: [30, 39],
            ...
            {
                id: 303403,
                reward: [40211, 40212, 40213, 40000],
                demand: {
                    Battle: 3,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "任务开车",
                next: ["17301682153821991", "17286298285194759", "17286300497369245"],
                dialogues: [
                    {
                        id: 71003001,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "击杀第一波开车",
                next: ["17301682153821991", "17286300497369245"],
                dialogues: [
                    {
                        id: 71003002,
        ...
        levels: [
            {
                id: 303502,
                reward: [40214, 40215, 40216, 40000],
                demand: {
                    Battle: 2,
                },
                level: [30, 39],
            ...
            {
                id: 303503,
                reward: [40217, 40218, 40219, 40000],
                demand: {
                    Battle: 3,
                },
                level: [40, 49],
            ...
            {
                id: 303504,
                reward: [40220, 40221, 40222, 40000],
                demand: {
                    Battle: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "开车",
                next: ["1730015153524780081", "1730015163890780381", "1730015165883780480", "1730015867841786306"],
                dialogues: [
                    {
                        id: 71003201,
        ...
        levels: [
            {
                id: 203704,
                reward: [40223, 40224, 40225, 40000],
                demand: {
                    Mine: 3,
                },
                level: [50, 59],
            ...
            {
                id: 203705,
                reward: [40226, 40227, 40228, 40000],
                demand: {
                    Mine: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 303805,
                reward: [40229, 40230, 40231, 40000],
                demand: {
                    Pet: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 104004,
                reward: [40232, 40233, 40234, 40000],
                demand: {
                    Battle: 2,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "皎皎选项对话",
                next: ["17328805251401011", "17328805251411020", "17328805251411012", "17328805251401005"],
                dialogues: [
                    {
                        id: 71001702,
                        content: "哼嗯，我得好好研究一下这里，你可要保护好我哦。",
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "皎皎开车对话",
                next: ["17328805251411012", "17328805251401005"],
                dialogues: [
                    {
                        id: 71001704,
                        content: "这里这样，再这样……嗯……快了快了，再等等哈。",
        ...
        levels: [
            {
                id: 204405,
                reward: [40235, 40236, 40237, 40000],
                demand: {
                    Collect: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "开车对话",
                next: ["17331391356532740157", "1733137502490215111"],
                dialogues: [
                    {
                        id: 71003501,
        ...
        levels: [
            {
                id: 104524,
                reward: [40241, 40242, 40243, 40000],
                demand: {
                    Morality: 2,
                },
                level: [50, 59],
            ...
            {
                id: 104554,
                reward: [40238, 40239, 40240, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "磁暴机出现开车",
                next: ["1733301985076892", "17333020012021437", "17333019938241163"],
                dialogues: [
                    {
                        id: 71003601,
        ...
        levels: [
            {
                id: 304604,
                reward: [40244, 40245, 40246, 40000],
                demand: {
                    Battle: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "交互对话",
                next: ["1733390377241867", "17389193325263037998", "17333922705951264955", "1733390377241879"],
                dialogues: [
                    {
                        id: 71003702,
        ...
        levels: [
            {
                id: 304705,
                reward: [40247, 40248, 40249, 40000],
                demand: {
                    Collect: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "看到秽兽群开车",
                next: ["1733473884441832", "17334739246391958"],
                dialogues: [
                    {
                        id: 71003801,
        ...
        levels: [
            {
                id: 104804,
                reward: [40250, 40251, 40252, 40000],
                demand: {
                    Battle: 2,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 105004,
                reward: [40253, 40254, 40255, 40000],
                demand: {
                    Battle: 2,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 205105,
                reward: [40256, 40257, 40258, 40000],
                demand: {
                    Collect: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17339857752195069", "17339859268628057"],
                dialogues: [
                    {
                        id: 71004202,
                        content: "你在干什么？",
        ...
        levels: [
            {
                id: 105203,
                reward: [40259, 40260, 40261, 40000],
                demand: {
                    Collect: 2,
                },
                level: [40, 49],
            ...
            {
                id: 105204,
                reward: [40262, 40263, 40264, 40000],
                demand: {
                    Collect: 2,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 305304,
                reward: [40265, 40266, 40267, 40000],
                demand: {
                    Pet: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 205405,
                reward: [40268, 40269, 40270, 40000],
                demand: {
                    Collect: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "解救宠物开车",
                next: ["17496245223343461367", "17496245223343461368"],
                dialogues: [
                    {
                        id: 71004401,
        ...
        levels: [
            {
                id: 305503,
                reward: [40271, 40272, 40273, 40000],
                demand: {
                    Pet: 3,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        levels: [
            {
                id: 305604,
                reward: [40274, 40275, 40276, 40000],
                demand: {
                    Collect: 3,
                },
                level: [50, 59],
            ...
            {
                id: 305605,
                reward: [40277, 40278, 40279, 40000],
                demand: {
                    Collect: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 205705,
                reward: [40280, 40281, 40282, 40000],
                demand: {
                    Collect: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "拾取开车",
                next: ["17347742024902273153", "17349199775691487", "17349224256022046976"],
                dialogues: [
                    {
                        id: 71004701,
                        content: "（远处闪闪发光的东西吸引了你的注意，靠近看看到底是什么吧。）",
        ...
        levels: [
            {
                id: 305804,
                reward: [40283, 40284, 40285, 40000],
                demand: {
                    Collect: 3,
                },
                level: [50, 59],
            ...
            {
                id: 305805,
                reward: [40286, 40287, 40288, 40000],
                demand: {
                    Collect: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "清理对话",
                next: ["17351098028014167", "17351096122601397"],
                dialogues: [
                    {
                        id: 71004802,
        ...
        levels: [
            {
                id: 105904,
                reward: [40289, 40290, 40291, 40000],
                demand: {
                    Collect: 2,
                },
                level: [50, 59],
            ...
            {
                id: 105905,
                reward: [40292, 40293, 40294, 40000],
                demand: {
                    Collect: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "钓鱼人交互对话",
                next: ["17351274086864886883", "17351964542182805135", "17351245747371396790"],
                dialogues: [
                    {
                        id: 71004902,
        ...
        levels: [
            {
                id: 206004,
                reward: [40295, 40296, 40297, 40000],
                demand: {
                    Fish: 3,
                },
                level: [50, 59],
            ...
            {
                id: 206005,
                reward: [40298, 40299, 40300, 40000],
                demand: {
                    Fish: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 306105,
                reward: [40301, 40302, 40303, 40000],
                demand: {
                    Pet: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "1780294792212546786",
                type: "TalkNode",
                name: "拍照开车",
                next: ["1780294792212546787"],
                dialogues: [
                    {
                        id: 71005001,
            ...
            {
                id: "1780294792212546787",
                type: "TalkNode",
                name: "交互开车",
                next: ["1780294792212546790"],
                dialogues: [
                    {
                        id: 71005002,
        ...
        levels: [
            {
                id: 306204,
                reward: [40304, 40305, 40306, 40000],
                demand: {
                    Collect: 3,
                },
                level: [50, 59],
            ...
            {
                id: 306205,
                reward: [40307, 40308, 40309, 40000],
                demand: {
                    Collect: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "鱼都被你惊走了",
                next: ["17355573675241404536", "17355573687811404590", "17355573702351404645"],
                dialogues: [
                    {
                        id: 71005107,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "绝世钓鱼饵料秘方，去采集",
                next: ["1735645444397714471", "17356338232029631"],
                dialogues: [
                    {
                        id: 71005111,
                        content: "我钓到了，你的鱼呢？",
        ...
        levels: [
            {
                id: 306304,
                reward: [40310, 40311, 40312, 40000],
                demand: {
                    Fish: 3,
                },
                level: [50, 59],
            ...
            {
                id: 306305,
                reward: [40313, 40314, 40315, 40000],
                demand: {
                    Fish: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "买花",
                next: ["17361496084264314", "17361496134204460"],
                dialogues: [
                    {
                        id: 71005214,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17361495496112997", "17361495563663188"],
                dialogues: [
                    {
                        id: 71005202,
        ...
        levels: [
            {
                id: 206434,
                reward: [40319, 40320, 40321, 40000],
                demand: {
                    Wisdom: 3,
                },
                level: [50, 59],
            ...
            {
                id: 206444,
                reward: [40316, 40317, 40318, 40000],
                demand: {
                    Empathy: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "小混混离开后选择",
                next: ["17357866196488312", "17358005146902108936"],
                dialogues: [
                    {
                        id: 71005308,
        ...
        levels: [
            {
                id: 106543,
                reward: [40322, 40323, 40324, 40000],
                demand: {
                    Empathy: 2,
                },
                level: [40, 49],
            ...
            {
                id: 106544,
                reward: [40328, 40329, 40330, 40000],
                demand: {
                    Empathy: 2,
                },
                level: [50, 59],
            ...
            {
                id: 106553,
                reward: [40325, 40326, 40327, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [40, 49],
            ...
            {
                id: 106554,
                reward: [40331, 40332, 40333, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "选择开启匣子",
                next: ["17358124635791401739", "17358127109881404299", "17358125334741403001"],
                dialogues: [
                    {
                        id: 71005402,
        ...
        levels: [
            {
                id: 106635,
                reward: [40334, 40335, 40336, 40000],
                demand: {
                    Wisdom: 3,
                },
                level: [60, 65],
            ...
            {
                id: 106655,
                reward: [40337, 40338, 40339, 40000],
                demand: {
                    Chaos: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17363168841782593", "17363168989182906", "17363171406525306", "17363217500712831557"],
                dialogues: [
                    {
                        id: 71005503,
        ...
        startIds: ["17363166248501104", "17363167426871472", "17363370863315192"],
        levels: [
            {
                id: 206711,
                reward: [40340, 40341, 40342, 40000],
                demand: {
                    Benefit: 1,
                },
                level: [1, 29],
            ...
            {
                id: 206712,
                reward: [40346, 40347, 40348, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [30, 39],
            ...
            {
                id: 206713,
                reward: [40352, 40353, 40354, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [40, 49],
            ...
            {
                id: 206731,
                reward: [40343, 40344, 40345, 40000],
                demand: {
                    Wisdom: 1,
                },
                level: [1, 29],
            ...
            {
                id: 206732,
                reward: [40349, 40350, 40351, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [30, 39],
            ...
            {
                id: 206733,
                reward: [40355, 40356, 40357, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "解救宠物开车",
                next: ["1736505932733239587", "1736505932733239588"],
                dialogues: [
                    {
                        id: 71004401,
                        content: "（游荡的秽兽挤满了四周，先击退它们，再去解救魔灵吧。）",
        ...
        levels: [
            {
                id: 306802,
                reward: [40358, 40359, 40360, 40000],
                demand: {
                    Pet: 2,
                },
                level: [30, 39],
    ...
    },
    {
        ...
        levels: [
            {
                id: 206905,
                reward: [40361, 40362, 40363, 40000],
                demand: {
                    Fish: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 207005,
                reward: [40364, 40365, 40366, 40000],
                demand: {
                    Fish: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 307105,
                reward: [40367, 40368, 40369, 40000],
                demand: {
                    Pet: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "交互对话",
                next: ["17369961811741692784", "17369312020249563"],
                dialogues: [
                    {
                        id: 71005802,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17369962024531693122", "173693147226712177"],
                dialogues: [
                    {
                        id: 71005806,
                        content: "前面还有，你还要吗？",
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17369950811591690932", "17369387875972899393"],
                dialogues: [
                    {
                        id: 71005809,
                        content: "前面还有，你还要吗？",
        ...
        levels: [
            {
                id: 207213,
                reward: [40373, 40374, 40375, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [40, 49],
            ...
            {
                id: 207214,
                reward: [40379, 40380, 40381, 40000],
                demand: {
                    Benefit: 3,
                },
                level: [50, 59],
            ...
            {
                id: 207233,
                reward: [40370, 40371, 40372, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [40, 49],
            ...
            {
                id: 207234,
                reward: [40376, 40377, 40378, 40000],
                demand: {
                    Wisdom: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17370099970278173", "173701090538818632", "173701131915125665", "173701133281625961", "173701124208323619"],
                dialogues: [
                    {
                        id: 71005904,
        ...
        levels: [
            {
                id: 207315,
                reward: [40385, 40386, 40387, 40000],
                demand: {
                    Benefit: 4,
                },
                level: [60, 65],
            ...
            {
                id: 207345,
                reward: [40382, 40383, 40384, 40000],
                demand: {
                    Empathy: 4,
                },
                level: [60, 65],
            ...
            {
                id: 207355,
                reward: [40388, 40389, 40390, 40000],
                demand: {
                    Chaos: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 307402,
                reward: [40391, 40392, 40393, 40000],
                demand: {
                    Pet: 2,
                },
                level: [30, 39],
            ...
            {
                id: 307403,
                reward: [40394, 40395, 40396, 40000],
                demand: {
                    Pet: 3,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        levels: [
            {
                id: 307504,
                reward: [40397, 40398, 40399, 40000],
                demand: {
                    Pet: 3,
                },
                level: [50, 59],
            ...
            {
                id: 307505,
                reward: [40400, 40401, 40402, 40000],
                demand: {
                    Pet: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17371094338652208400", "173710125978814418", "17371087069472206713"],
                dialogues: [
                    {
                        id: 71006102,
        ...
        levels: [
            {
                id: 207614,
                reward: [40403, 40404, 40405, 40000],
                demand: {
                    Benefit: 3,
                },
                level: [50, 59],
            ...
            {
                id: 207615,
                reward: [40409, 40410, 40411, 40000],
                demand: {
                    Benefit: 4,
                },
                level: [60, 65],
            ...
            {
                id: 207654,
                reward: [40406, 40407, 40408, 40000],
                demand: {
                    Chaos: 3,
                },
                level: [50, 59],
            ...
            {
                id: 207655,
                reward: [40412, 40413, 40414, 40000],
                demand: {
                    Chaos: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 207704,
                reward: [40415, 40416, 40417, 40000],
                demand: {
                    Fish: 3,
                },
                level: [50, 59],
            ...
            {
                id: 207705,
                reward: [40418, 40419, 40420, 40000],
                demand: {
                    Fish: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 207804,
                reward: [40421, 40422, 40423, 40000],
                demand: {
                    Fish: 3,
                },
                level: [50, 59],
            ...
            {
                id: 207805,
                reward: [40424, 40425, 40426, 40000],
                demand: {
                    Fish: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "皎皎选项对话",
                next: ["1741155805078191", "1741155805079200", "1741155805077185", "1741155805078192"],
                dialogues: [
                    {
                        id: 71001702,
                        content: "哼嗯，我得好好研究一下这里，你可要保护好我哦。",
        ...
        levels: [
            {
                id: 207903,
                reward: [40427, 40428, 40429, 40000],
                demand: {
                    Collect: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "皎皎npc选项对话",
                next: ["174116384118978", "174116384119082", "174116384119086", "174116384119085"],
                dialogues: [
                    {
                        id: 71002402,
                        content: "我们在这种地方都能遇到，太有缘了吧！既然你来了，那要不要帮忙照看下我的宝贝勘探器？",
        ...
        startIds: ["174116384118972", "174116384119193"],
        levels: [
            {
                id: 308005,
                reward: [40430, 40431, 40432, 40000],
                demand: {
                    Collect: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["174116795662971", "174116795662978"],
                dialogues: [
                    {
                        id: 71004202,
                        content: "你在干什么？",
        ...
        levels: [
            {
                id: 108103,
                reward: [40433, 40434, 40435, 40000],
                demand: {
                    Collect: 2,
                },
                level: [40, 49],
    ...
    },
    {
        ...
        levels: [
            {
                id: 108203,
                reward: [40436, 40437, 40438, 40000],
                demand: {
                    Battle: 2,
                },
                level: [40, 49],
            ...
            {
                id: 108204,
                reward: [40439, 40440, 40441, 40000],
                demand: {
                    Battle: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17562954699533484", "17495601331721460"],
                dialogues: [
                    {
                        id: 71006511,
                        content: "休息好了吗？",
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17495602613271904", "17496263463945591037", "17496264928005593424", "17496264954145593498"],
                dialogues: [
                    {
                        id: 71006506,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17562954919003854", "17496265097285593813"],
                dialogues: [
                    {
                        id: 71006512,
                        content: "休息好了吗？",
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17562955152104298", "17496265124845593884"],
                dialogues: [
                    {
                        id: 71006513,
                        content: "休息好了吗？",
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17562956549245783", "17503182427321933109"],
                dialogues: [
                    {
                        id: 71006511,
                        content: "休息好了吗？",
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17562956549245784", "17503182427321933111"],
                dialogues: [
                    {
                        id: 71006512,
                        content: "休息好了吗？",
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17562956549245785", "17503182427321933113"],
                dialogues: [
                    {
                        id: 71006513,
                        content: "休息好了吗？",
        ...
        levels: [
            {
                id: 308314,
                reward: [40442, 40443, 40444, 40000],
                demand: {
                    Benefit: 3,
                },
                level: [50, 59],
            ...
            {
                id: 308315,
                reward: [40448, 40449, 40450, 40000],
                demand: {
                    Benefit: 4,
                },
                level: [60, 65],
            ...
            {
                id: 308334,
                reward: [40445, 40446, 40447, 40000],
                demand: {
                    Wisdom: 3,
                },
                level: [50, 59],
            ...
            {
                id: 308335,
                reward: [40451, 40452, 40453, 40000],
                demand: {
                    Wisdom: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "解救宠物开车",
                next: ["17344917015822647", "17344917015822648"],
                dialogues: [
                    {
                        id: 71007301,
        ...
        levels: [
            {
                id: 308404,
                reward: [40454, 40455, 40456, 40000],
                demand: {
                    Pet: 4,
                },
                level: [50, 59],
            ...
            {
                id: 308405,
                reward: [40457, 40458, 40459, 40000],
                demand: {
                    Pet: 5,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17491109520566341", "17495423373383106626"],
                dialogues: [
                    {
                        id: 71006602,
        ...
        levels: [
            {
                id: 208503,
                reward: [40460, 40461, 40462, 40000],
                demand: {
                    Collect: 2,
                },
                level: [40, 49],
            ...
            {
                id: 208504,
                reward: [40463, 40464, 40465, 40000],
                demand: {
                    Collect: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 208604,
                reward: [40466, 40467, 40468, 40000],
                demand: {
                    Collect: 3,
                },
                level: [50, 59],
            ...
            {
                id: 208605,
                reward: [40469, 40470, 40471, 40000],
                demand: {
                    Collect: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17498020673127504", "174980220162410143", "17498020109305787"],
                dialogues: [
                    {
                        id: 71006709,
        ...
        levels: [
            {
                id: 208723,
                reward: [40472, 40473, 40474, 40000],
                demand: {
                    Morality: 3,
                },
                level: [40, 49],
            ...
            {
                id: 208724,
                reward: [40481, 40482, 40483, 40000],
                demand: {
                    Morality: 4,
                },
                level: [50, 59],
            ...
            {
                id: 208733,
                reward: [40475, 40476, 40477, 40000],
                demand: {
                    Wisdom: 3,
                },
                level: [40, 49],
            ...
            {
                id: 208734,
                reward: [40484, 40485, 40486, 40000],
                demand: {
                    Wisdom: 4,
                },
                level: [50, 59],
            ...
            {
                id: 208753,
                reward: [40478, 40479, 40480, 40000],
                demand: {
                    Chaos: 3,
                },
                level: [40, 49],
            ...
            {
                id: 208754,
                reward: [40487, 40488, 40489, 40000],
                demand: {
                    Chaos: 4,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17388225288744588", "17498997048213385", "17501470335791267046"],
                dialogues: [
                    {
                        id: 71006902,
        ...
        levels: [
            {
                id: 208804,
                reward: [40490, 40491, 40492, 40000],
                demand: {
                    Fish: 3,
                },
                level: [50, 59],
            ...
            {
                id: 208805,
                reward: [40493, 40494, 40495, 40000],
                demand: {
                    Fish: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["1750166175140636985", "1750166188974637494"],
                dialogues: [
                    {
                        id: 71007108,
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["1750166084867635616", "1750169360732642308"],
                dialogues: [
                    {
                        id: 710071061,
        ...
        levels: [
            {
                id: 108923,
                reward: [40496, 40497, 40498, 40000],
                demand: {
                    Morality: 2,
                },
                level: [40, 49],
            ...
            {
                id: 108924,
                reward: [40502, 40503, 40504, 40000],
                demand: {
                    Morality: 3,
                },
                level: [50, 59],
            ...
            {
                id: 108943,
                reward: [40499, 40500, 40501, 40000],
                demand: {
                    Empathy: 2,
                },
                level: [40, 49],
            ...
            {
                id: 108944,
                reward: [40505, 40506, 40507, 40000],
                demand: {
                    Empathy: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "小贩对话",
                next: ["17501520042682862", "17575778221273201731", "17501639742181275563"],
                dialogues: [
                    {
                        id: 71007005,
        ...
        levels: [
            {
                id: 109024,
                reward: [40514, 40515, 40516, 40000],
                demand: {
                    Morality: 3,
                },
                level: [50, 59],
            ...
            {
                id: 109025,
                reward: [40523, 40524, 40525, 40000],
                demand: {
                    Morality: 4,
                },
                level: [60, 65],
            ...
            {
                id: 109044,
                reward: [40508, 40509, 40510, 40000],
                demand: {
                    Empathy: 3,
                },
                level: [50, 59],
            ...
            {
                id: 109045,
                reward: [40517, 40518, 40519, 40000],
                demand: {
                    Empathy: 4,
                },
                level: [60, 65],
            ...
            {
                id: 109054,
                reward: [40511, 40512, 40513, 40000],
                demand: {
                    Chaos: 3,
                },
                level: [50, 59],
            ...
            {
                id: 109055,
                reward: [40520, 40521, 40522, 40000],
                demand: {
                    Chaos: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17502460202332776", "17502460237112933"],
                dialogues: [
                    {
                        id: 71007203,
        ...
        levels: [
            {
                id: 109113,
                reward: [40526, 40527, 40528, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [40, 49],
            ...
            {
                id: 109114,
                reward: [40532, 40533, 40534, 40000],
                demand: {
                    Benefit: 3,
                },
                level: [50, 59],
            ...
            {
                id: 109123,
                reward: [40529, 40530, 40531, 40000],
                demand: {
                    Morality: 2,
                },
                level: [40, 49],
            ...
            {
                id: 109124,
                reward: [40535, 40536, 40537, 40000],
                demand: {
                    Morality: 3,
                },
                level: [50, 59],
    ...
    },
    {
        ...
        levels: [
            {
                id: 109204,
                reward: [40544, 40545, 40546, 40000],
                demand: {
                    Battle: 1,
                },
                level: [50, 59],
            ...
            {
                id: 109205,
                reward: [40547, 40548, 40549, 40000],
                demand: {
                    Battle: 1,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17580910816542092", "1768819009599741651", "17580911116652528"],
                dialogues: [
                    {
                        id: 71007502,
            ...
            {
                id: "17580909738381018",
                type: "TalkNode",
                name: "对话节点",
                next: ["1758090939097444"],
                dialogues: [
                    {
                        id: 71007501,
            ...
            {
                id: "17580910816542092",
                type: "TalkNode",
                name: "海鸥来袭开车",
                next: ["1768819009599741651", "17580911116652528"],
                dialogues: [
                    {
                        id: 71007506,
                    ...
                    },
                    {
                        id: 71007507,
                        content:
                            "（这些云翎鸥盘旋在四周久久不愿离去，稍有机会就朝男子飞近一些。就好像它们存在的意义就是土豆丝，活着的目标就是从男子手上抢走土豆丝一样。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17580911116652528",
                type: "TalkNode",
                name: "赶走对话",
                dialogues: [
                    {
        ...
        levels: [
            {
                id: 209304,
                reward: [40550, 40551, 40552, 40000],
                demand: {
                    Collect: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209305,
                reward: [40553, 40554, 40555, 40000],
                demand: {
                    Collect: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "1775805894448486180",
                type: "TalkNode",
                name: "解救宠物开车",
                next: ["1775805894448486186", "1775805894448486187"],
                dialogues: [
                    {
                        id: 71007301,
                        content: "（游荡的敌人挤满了四周，先击退它们，再去解救魔灵吧。）",
            ...
            {
                id: "1775805894448486186",
                type: "TalkNode",
                name: "击杀秽兽开车",
                next: ["1775805894448486187"],
                dialogues: [
                    {
                        id: 71007302,
                        content: "（争斗的声响引来了更多敌人。）",
        ...
        levels: [
            {
                id: 309404,
                reward: [40556, 40557, 40558, 40000],
                demand: {
                    Pet: 3,
                },
                level: [50, 59],
            ...
            {
                id: 309405,
                reward: [40559, 40560, 40561, 40000],
                demand: {
                    Pet: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 209504,
                reward: [40562, 40563, 40564, 40000],
                demand: {
                    Fish: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209505,
                reward: [40565, 40566, 40567, 40000],
                demand: {
                    Fish: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            {
                id: "1780294792168536704",
                type: "TalkNode",
                name: "对话节点",
                next: ["1780294792168536705"],
                dialogues: [
                    {
                        id: 71007701,
                        content: "奇怪，到底掉到哪里去了……",
            ...
            {
                id: "1780294792168536705",
                type: "TalkNode",
                name: "对话节点",
                next: ["1780294792168536708", "1780294792168536711", "1780294792168536712"],
                dialogues: [
                    {
                        id: 71007702,
            ...
            {
                id: "1780294792168536708",
                type: "TalkNode",
                name: "对话节点",
                next: ["1780294792168536716", "1780294792168536718"],
                dialogues: [
                    {
                        id: 71007712,
            ...
            {
                id: "1780294792168536716",
                type: "TalkNode",
                name: "对话节点",
                next: ["17587853213285627", "17587853327275896", "17587853413986077"],
                dialogues: [
                    {
                        id: 71007705,
            ...
            {
                id: "1780294792168536718",
                type: "TalkNode",
                name: "锦鲤皎皎开车",
                next: ["1780294792168536716"],
                dialogues: [
                    {
                        id: 71007704,
        ...
        levels: [
            {
                id: 209614,
                reward: [40568, 40569, 40570, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209615,
                reward: [40577, 40578, 40579, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [60, 65],
            ...
            {
                id: 209624,
                reward: [40571, 40572, 40573, 40000],
                demand: {
                    Morality: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209625,
                reward: [40580, 40581, 40582, 40000],
                demand: {
                    Morality: 2,
                },
                level: [60, 65],
            ...
            {
                id: 209654,
                reward: [40574, 40575, 40576, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209655,
                reward: [40583, 40584, 40585, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            {
                id: "17590416757281048",
                type: "TalkNode",
                name: "对话节点",
                next: ["17590422281204669"],
                dialogues: [
                    {
                        id: 71007802,
                        content: "那边……请……点燃……谢谢……",
            ...
            {
                id: "17590423692847037",
                type: "TalkNode",
                name: "对话节点",
                next: ["17590424229528161"],
                dialogues: [
                    {
                        id: 71007813,
            ...
            {
                id: "17590423958037490",
                type: "TalkNode",
                name: "开车对话",
                next: ["17590497002711331015"],
                dialogues: [
                    {
                        id: 71007810,
            ...
            {
                id: "17590424195418022",
                type: "TalkNode",
                name: "开车对话",
                next: ["17590424638308490"],
                dialogues: [
                    {
                        id: 71007807,
                        content: "（烟雾散去，方才见到的一切也随之消散。回去问问无由生是怎么回事吧。）",
            ...
            {
                id: "17590424229528161",
                type: "TalkNode",
                name: "开车对话",
                next: ["17590497047011331160"],
                dialogues: [
                    {
                        id: 71007814,
                        content: "（烟雾散去，方才见到的一切也随之消散。回去问问无由生是怎么回事吧。）",
            ...
            {
                id: "17590496050511329410",
                type: "TalkNode",
                name: "开车对话",
                next: ["17590424195418022"],
                dialogues: [
                    {
                        id: 71007806,
            ...
            {
                id: "17590496116421329651",
                type: "TalkNode",
                name: "开车对话",
                next: ["17590423958037490"],
                dialogues: [
                    {
                        id: 71007809,
            ...
            {
                id: "17590496149921329787",
                type: "TalkNode",
                name: "开车对话",
                next: ["17590423692847037"],
                dialogues: [
                    {
                        id: 71007812,
        ...
        levels: [
            {
                id: 209714,
                reward: [40586, 40587, 40588, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209715,
                reward: [40595, 40596, 40597, 40000],
                demand: {
                    Benefit: 2,
                },
                level: [60, 65],
            ...
            {
                id: 209724,
                reward: [40589, 40590, 40591, 40000],
                demand: {
                    Morality: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209725,
                reward: [40598, 40599, 40600, 40000],
                demand: {
                    Morality: 2,
                },
                level: [60, 65],
            ...
            {
                id: 209744,
                reward: [40592, 40593, 40594, 40000],
                demand: {
                    Empathy: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209745,
                reward: [40601, 40602, 40603, 40000],
                demand: {
                    Empathy: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            {
                id: "17599982959691235",
                type: "TalkNode",
                name: "对话节点",
                next: ["17599985233293004"],
                dialogues: [
                    {
                        id: 71007905,
                        content:
                            "谢谢你救了我，但我没什么好东西能够报答你……对了，我这有一张爸爸留下的藏宝图，要是你能找到宝藏，它们就归你了！",
                        npc: 818083,
                        options: [
                            {
                                id: 710079051,
        ...
        levels: [
            {
                id: 109834,
                reward: [40604, 40605, 40606, 40000],
                demand: {
                    Wisdom: 1,
                },
                level: [50, 59],
            ...
            {
                id: 109835,
                reward: [40610, 40611, 40612, 40000],
                demand: {
                    Wisdom: 1,
                },
                level: [60, 65],
            ...
            {
                id: 109844,
                reward: [40607, 40608, 40609, 40000],
                demand: {
                    Empathy: 1,
                },
                level: [50, 59],
            ...
            {
                id: 109845,
                reward: [40613, 40614, 40615, 40000],
                demand: {
                    Empathy: 1,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "17604258605903647",
                type: "TalkNode",
                name: "对话节点",
                next: ["17604127057182948580", "17604279169031967675"],
                dialogues: [
                    {
                        id: 71008010,
                        content:
                            "（男子给你的这笔钱无疑就是他们在酝酿什么阴谋的证据，现在可以直接回去交差，揭露二人的阴谋，或是藏在附近，继续听听这二人的对话。）",
                        npc: 100001,
                    },
                ],
            },
            {
                id: "17604122884922292346",
                type: "TalkNode",
                name: "对话节点",
                next: ["17604125580152292969"],
                dialogues: [
                    {
                        id: 71008001,
            ...
            {
                id: "17604125580152292969",
                type: "TalkNode",
                name: "对话节点",
                next: ["17604126955982948298"],
                dialogues: [
                    {
                        id: 71008002,
            ...
            {
                id: "17604126827142947919",
                type: "TalkNode",
                name: "对话节点",
                next: ["17604127057182948580", "17604258605903647", "17604279169031967675"],
                dialogues: [
                    {
                        id: 71008009,
            ...
            {
                id: "17604126955982948298",
                type: "TalkNode",
                name: "对话节点",
                next: ["17604126827142947919"],
                dialogues: [
                    {
                        id: 71008004,
            ...
            {
                id: "17604279169031967675",
                type: "TalkNode",
                name: "对话节点",
                next: ["17604287360623277166", "17604127057182948580"],
                dialogues: [
                    {
                        id: 71008011,
        ...
        levels: [
            {
                id: 209934,
                reward: [40616, 40617, 40618, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209935,
                reward: [40622, 40623, 40624, 40000],
                demand: {
                    Wisdom: 2,
                },
                level: [60, 65],
            ...
            {
                id: 209954,
                reward: [40619, 40620, 40621, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [50, 59],
            ...
            {
                id: 209955,
                reward: [40625, 40626, 40627, 40000],
                demand: {
                    Chaos: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 110004,
                reward: [40628, 40629, 40630, 40000],
                demand: {
                    Battle: 1,
                },
                level: [50, 59],
            ...
            {
                id: 110005,
                reward: [40631, 40632, 40633, 40000],
                demand: {
                    Battle: 1,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            {
                id: "17605190532281078",
                type: "TalkNode",
                name: "对话节点",
                next: ["1760520284508659693"],
                dialogues: [
                    {
                        id: 71008102,
            ...
            {
                id: "1760520191491658910",
                type: "TalkNode",
                name: "对话节点",
                next: ["1760520599738661864", "17605251946541987940", "17605251973691988025", "1760520628746662285"],
                dialogues: [
                    {
                        id: 71008106,
            ...
            {
                id: "1760520284508659693",
                type: "TalkNode",
                name: "对话节点",
                next: ["1760520628746662285", "1760520599738661864", "17605251946541987940", "17605251973691988025", "1760520191491658910"],
                dialogues: [
                    {
                        id: 71008104,
        ...
        levels: [
            {
                id: 110104,
                reward: [40634, 40635, 40636, 40000],
                demand: {
                    Collect: 1,
                },
                level: [50, 59],
            ...
            {
                id: 110105,
                reward: [40637, 40638, 40639, 40000],
                demand: {
                    Collect: 1,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        levels: [
            {
                id: 210205,
                reward: [40538, 40539, 40540, 40000],
                demand: {
                    Mine: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["1768462477049862", "17660444659281775357", "17660444249131774844"],
                dialogues: [
                    {
                        id: 71008201,
        ...
        levels: [
            {
                id: 310305,
                reward: [40541, 40542, 40543, 40000],
                demand: {
                    Mine: 4,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                ...
                type: "TalkNode",
                name: "解救宠物开车",
                next: ["1758264789181357", "1758264789181358"],
                dialogues: [
                    {
                        id: 71008701,
                        content: "（游荡的敌人挤满了四周，先击退它们，再去解救魔灵吧。）",
        ...
        levels: [
            {
                id: 310404,
                reward: [40646, 40647, 40648, 40000],
                demand: {
                    Pet: 3,
                },
                level: [50, 59],
            ...
            {
                id: 310405,
                reward: [40649, 40650, 40651, 40000],
                demand: {
                    Pet: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "交互开车",
                next: ["1749799107834369975"],
                dialogues: [
                    {
                        id: 71008602,
                        content: "这位朋友，你能帮我拍几张照片吗？难得来一趟百花车站，不留点合影就太可惜了。",
                        npc: 818041,
                        options: [
                            {
                                id: 710086021,
                    ...
                    {
                        id: 71008604,
                        content: "太好了，记得把我后面的“铁之心”纪念碑也拍进去哦，我很喜欢它的造型。",
                        npc: 818041,
                        next: 71008605,
                    },
                ],
        ...
        levels: [
            {
                id: 210504,
                reward: [40652, 40653, 40654, 40000],
                demand: {
                    Collect: 2,
                },
                level: [50, 59],
            ...
            {
                id: 210505,
                reward: [40655, 40656, 40657, 40000],
                demand: {
                    Collect: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            ...
            },
            {
                ...
                type: "TalkNode",
                name: "对话节点",
                next: ["17587851501072400", "17587851675803046", "17587851740993276"],
                dialogues: [
                    {
                        id: 71008902,
                        content: "我的火车票找不到了，它装在一个紫色的小包里，你能帮我一起找找吗？",
                        npc: 818095,
                        options: [
                            {
                                id: 710089021,
            ...
            {
                id: "17587851501072400",
                type: "TalkNode",
                name: "对话节点",
                next: ["17587852634654824", "17587898066033277422"],
                dialogues: [
                    {
                        id: 71008912,
                        content: "（没看到紫色小包，再去其他地方找找。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17587851675803046",
                type: "TalkNode",
                name: "对话节点",
                next: ["17587852634654824", "17587898066033277422"],
                dialogues: [
            ...
            {
                id: "17587852634654824",
                type: "TalkNode",
                name: "对话节点",
                next: ["17757923762108167105", "1775789404497910903", "1775789413019911102", "17757923807538167260"],
                dialogues: [
                    {
                        id: 71008905,
                        content: "是来找遗失物的吗？跟我描述一下它的样子吧。",
                        npc: 818096,
                        options: [
                            {
                                id: 710089051,
                                content: "紫色的小包，里面有一张火车票。",
                                next: 71008906,
                            },
                            {
                                id: 710089052,
                                content: "蓝色的小包，里面有一些铜币。",
                                next: 71008911,
                            },
                            {
                                id: 710089053,
                                content: "红色的小包，里面有一张夫妻合照。",
                                next: 71008911,
                            },
                        ],
                    },
                    {
                        id: 71008906,
                        content: "嗯，确有此物，拿去吧，可别再弄丢了啊。",
                        npc: 818096,
                        next: 71008913,
                    },
                    {
                        id: 71008911,
                        content: "抱歉，我没找到你说的东西。",
                        npc: 818096,
                        next: 71008910,
                    },
                ],
            ...
            {
                id: "1775789404497910903",
                type: "TalkNode",
                name: "找到",
                dialogues: [
                    {
                        id: 71008907,
                        content: "就是这个小包，太谢谢你了。",
                        npc: 818095,
                    },
                ],
            },
            {
                id: "1775789413019911102",
                type: "TalkNode",
                name: "没找到",
                dialogues: [
                    {
                        id: 71008910,
                        content: "没找到吗……好吧，辛苦你了，我自己再找找看。",
                        npc: 818095,
                    },
                ],
            },
            {
                id: "17587898066033277422",
                type: "TalkNode",
                name: "失物招领开车",
                next: ["17587852634654824"],
                dialogues: [
                    {
                        id: 71008904,
                        content: "（附近都没看到紫色小包，去问问工作人员吧。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17757923762108167105",
                type: "TalkNode",
                name: "失物招领开车",
                next: ["1775789404497910903"],
                dialogues: [
                    {
                        id: 71008913,
                        content: "（回去告诉那位旅客吧。）",
            ...
            {
                id: "17757923807538167260",
                type: "TalkNode",
                name: "失物招领开车",
                next: ["1775789413019911102"],
                dialogues: [
                    {
                        id: 71008913,
                        content: "（回去告诉那位旅客吧。）",
        ...
        levels: [
            {
                id: 210604,
                reward: [40658, 40659, 40660, 40000],
                demand: {
                    Collect: 2,
                },
                level: [50, 59],
            ...
            {
                id: 210605,
                reward: [40661, 40662, 40663, 40000],
                demand: {
                    Collect: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "1775703369389899644",
                type: "TalkNode",
                name: "npc开车对话",
                next: ["1775703369390899645"],
                dialogues: [
                    {
                        id: 71008801,
                        content: "怎么勘探器还没干活就坏了，我的修理工具呢……",
            ...
            {
                id: "1775703369390899645",
                type: "TalkNode",
                name: "皎皎npc选项对话",
                next: ["1775703369390899649", "1775703369391899653", "1775703369392899657", "1775703369392899656"],
                dialogues: [
                    {
                        id: 71008802,
                        content: "我们在这种地方都能遇到，太有缘了吧！既然你来了，那要不要帮忙照看下我的宝贝勘探器？",
            ...
            {
                id: "1775703369390899649",
                type: "TalkNode",
                name: "修理开车对话",
                next: ["1775703369391899653", "1775703369392899657", "1775703369392899656"],
                dialogues: [
                    {
                        id: 71008803,
                        content: "好耶，你就在它边上不要走动哦，我找到工具了就回来！",
            ...
            {
                id: "1775703369391899653",
                type: "TalkNode",
                name: "秽兽出现开车对话",
                next: ["1775703369392899656"],
                dialogues: [
                    {
                        id: 71008805,
                        content: "（勘探器的响动将周围的敌人吸引了过来，击退它们吧。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "1775703369392899656",
                type: "TalkNode",
                name: "击杀秽兽后的对话",
                dialogues: [
                    {
        ...
        startIds: ["1775703369389899644", "1775703369393899664"],
        levels: [
            {
                id: 310704,
                reward: [40664, 40665, 40666, 40000],
                demand: {
                    Collect: 3,
                },
                level: [50, 59],
            ...
            {
                id: 310705,
                reward: [40667, 40668, 40669, 40000],
                demand: {
                    Collect: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "17757030931412206",
                type: "TalkNode",
                name: "开车",
                next: ["17757030931412208"],
                dialogues: [
                    {
                        id: 71008501,
                        content: "（远处传来木板掉落的声音，过去看看发生了什么吧。）",
                        npc: 818039,
                    },
                ],
            },
            {
                id: "17757030931412208",
                type: "TalkNode",
                name: "交互请求清理垃圾",
                next: ["17757030931412213"],
                dialogues: [
                    {
                        id: 71008502,
                        content: "狩月人？你来得正好，这批建材不小心掉轨道上了，你能帮我一起清理下吗？",
                        npc: 818039,
                        options: [
                            {
                                id: 710085031,
        ...
        levels: [
            {
                id: 210804,
                reward: [40670, 40671, 40672, 40000],
                demand: {
                    Mine: 2,
                },
                level: [50, 59],
            ...
            {
                id: 210805,
                reward: [40673, 40674, 40675, 40000],
                demand: {
                    Mine: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "17830610926631405",
                type: "TalkNode",
                name: "历战者出现开车",
                next: ["17830611978911082025"],
                dialogues: [
                    {
                        id: 71009002,
                        content: "（争斗的声响引来了更多秽兽，击退它们。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17823743482854326468",
                type: "TalkNode",
                name: "历战者出现开车",
                next: ["17830610926631405", "17830611978911082025"],
                dialogues: [
                    {
                        id: 71009001,
                        content: "（不详的化身终于降临于此。击败它吧，就像过去的无数次一样。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17830611978911082025",
                type: "TalkNode",
                name: "历战者出现开车",
                dialogues: [
                    {
        ...
        levels: [
            {
                id: 210904,
                reward: [40676, 40677, 40678, 40000],
                demand: {
                    Battle: 2,
                },
                level: [50, 59],
            ...
            {
                id: 210905,
                reward: [40679, 40680, 40681, 40000],
                demand: {
                    Battle: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "1782376173109592882",
                type: "TalkNode",
                name: "解救宠物开车",
                next: ["1782376173109592888", "1782376173109592889"],
                dialogues: [
                    {
                        id: 71009101,
                        content: "（游荡的敌人徘徊在附近，先击退它们，再去解救魔灵吧。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "1782376173109592888",
                type: "TalkNode",
                name: "击杀秽兽开车",
                next: ["1782376173109592889"],
                dialogues: [
                    {
                        id: 71009102,
                        content: "（争斗的声响引来了更多敌人。）",
        ...
        levels: [
            {
                id: 311004,
                reward: [40682, 40683, 40684, 40000],
                demand: {
                    Pet: 3,
                },
                level: [50, 59],
            ...
            {
                id: 311005,
                reward: [40685, 40686, 40687, 40000],
                demand: {
                    Pet: 3,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "17830613856413243167",
                type: "TalkNode",
                name: "对话节点",
                next: ["17830614052443243617", "17830614162003243914", "17830614106323243777"],
                dialogues: [
                    {
                        id: 71009201,
                        content: "（游荡的秽兽不安地嘶吼着，尽快击退它们吧。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17830614052443243617",
                type: "TalkNode",
                name: "对话节点",
                dialogues: [
                    {
                        id: 71009202,
                        content: "（争斗之中，有秽兽误触了附近遗留的军用武器，躲避这些武器的轰炸吧。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17830614106323243777",
                type: "TalkNode",
                name: "对话节点",
                dialogues: [
                    {
        ...
        levels: [
            {
                id: 211104,
                reward: [40688, 40689, 40690, 40000],
                demand: {
                    Battle: 2,
                },
                level: [50, 59],
            ...
            {
                id: 211105,
                reward: [40691, 40692, 40693, 40000],
                demand: {
                    Battle: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "17827191384701670783",
                type: "TalkNode",
                name: "开始开车",
                next: [
                    "17827191384701670785",
                    "17827191384701670787",
                    "17827191384701670789",
                    "17827191384701670791",
                    "17827191384701670793",
                    "17827191384701670786",
                    "17827191384701670788",
                    "17827191384701670790",
                    "17827191384701670792",
                    "17827191384701670794",
                ],
                dialogues: [
                    {
                        id: 71009301,
        ...
        levels: [
            {
                id: 211204,
                reward: [40694, 40695, 40696, 40000],
                demand: {
                    Collect: 2,
                },
                level: [50, 59],
            ...
            {
                id: 211205,
                reward: [40697, 40698, 40699, 40000],
                demand: {
                    Collect: 2,
                },
                level: [60, 65],
    ...
    },
    {
        ...
        nodes: [
            {
                id: "17830615326795406630",
                type: "TalkNode",
                name: "对话节点",
                next: ["17830646891498652733", "17830615663685407551"],
                dialogues: [
                    {
                        id: 71009401,
                        content: "（游荡的秽兽不断从山崖上冲上来，击退它们吧。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17830615663685407551",
                type: "TalkNode",
                name: "对话节点",
                dialogues: [
                    {
                        id: 71009403,
                        content: "（附近的所有秽兽都被你清理干净，这里暂时安全了。）",
                        npc: 800006,
                    },
                ],
            },
            {
                id: "17830646891498652733",
                type: "TalkNode",
                name: "对话节点",
                next: ["17830615663685407551"],
                dialogues: [
                    {
                        id: 71009402,
                        content: "（更多秽兽被打斗的声响吸引，爬上了山崖，击退它们吧。）",
                        npc: 800006,
                    },
                ],
            },
        ...
        levels: [
            {
                id: 211304,
                reward: [40700, 40701, 40702, 40000],
                demand: {
                    Battle: 2,
                },
                level: [50, 59],
            ...
            {
                id: 211305,
                reward: [40703, 40704, 40705, 40000],
                demand: {
                    Battle: 2,
                },
                level: [60, 65],
